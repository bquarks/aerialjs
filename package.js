...
Package.onUse(function (api) {
    ...
    api.use(['ecmascript', 'bquarks:aerial-mongo@0.0.16', 'bquarks:aerial-minimongo@0.0.23',
              'bquarks:aerial-corbel@0.2.18', 'bquarks:aerial-accounts@0.5.0'], { weak: false, unordered:false });
